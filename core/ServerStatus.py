...
def getStatus(address):
    ...
    s = 1 if dataResult['online'] else 0

    return(serverAddress,serverPort,serverisOnline,s,serverPlayersOnline,serverPlayersMax,serverVersion,serverMotd, currentDateTime)